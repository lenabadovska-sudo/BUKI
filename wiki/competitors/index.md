...
|---|---|---|---|
| Preply | [preply.md](preply.md) | Global / Польща | 2026-09-14 |
| Superprof | [superprof.md](superprof.md) | Польща | 2026-09-14 |
...
> ⚠️ Записи від 2026-09-13 і 2026-09-14 отримані **виключно через WebSearch**. Прямий site-diff не виконувався третій тиждень поспіль: `preply.com` і `www.superprof.pl` віддають `EGRESS_BLOCKED` на рівні мережевого проксі сесії (розблокувати allowlist може лише користувач). Тому в цих записах ніде не стоїть «без змін» — лише «зміна підтверджена» або «перевірку не виконано». Деталі — у [reviews/2026-09-14-weekly-brief.md](reviews/2026-09-14-weekly-brief.md).

Insights board (Figma): [BUKI Competitive Watch — Insights Board](https://www.figma.com/design/EYyAK9JeEkWQkbmNtuvcSS) — накопичувальна дошка, тепер 2 колонки (2026-09-13, 2026-09-14). Дошка — основне джерело для порівняння тижнів.
